...
<head>
<base href="/shopping/Public/Home/" />
...
<title>茶叶商城首页-火源网www.5l99.cn-模板,源码交易!织梦源码,织梦模板,网站模板,网站源码</title>
</head>
...
<div id="top">
  <div class="top">
	...
	<div class="hd_top_manu clearfix">
	  <ul class="clearfix">
	   <?php if($_SESSION['user']['user_name'] == null): ?><li class="hd_menu_tit zhuce" data-addclass="hd_menu_hover">欢迎光临本店！<a href="<?php echo U('Login/login');?>" class="red">[请登录]</a> 新用户<a href="<?php echo U('Login/register');?>" class="red">[免费注册]</a>	
	   <?php else: ?>
	   <li class="hd_menu_tit zhuce" data-addclass="hd_menu_hover">欢迎<?php echo ($_SESSION['user']['user_name']); ?>光临本店！ <a href="<?php echo U('Login/login_do');?>" class="red">退出登陆</a>
	   </li><?php endif; ?>

	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"><a href="#">我的订单</a></li> 
	   <li class="hd_menu_tit" data-addclass="hd_menu_hover"> <a href="<?php echo U('Cart/cart_show');?>">购物车(<b>0</b>)</a> </li>
...
<div id="header"  class="header">
  <div class="logo">
  <a href="#"><img src="images/logo.png" width="247xp" height="138xp" /></a>
  <div class="phone">
...
<div id="Menu" class="clearfix">
  ...
  <div id="allSortOuterbox">
    <div class="Category"><a href="<?php echo U('Goods/goods_list');?>" class="Menu_img"><em></em></a></div>
...
<div class="fixedBox">
  <ul class="fixedBoxList">
      <li class="fixeBoxLi user"><a href="<?php echo U('User/user_info');?>"> <span class="fixeBoxSpan"></span> <strong>用户</strong></a> </li>
    <li class="fixeBoxLi cart_bd" style="display:block;" id="cartboxs">
		<!-- <p class="good_cart">0</p> -->
			<span class="fixeBoxSpan"></span> <strong><a href="<?php echo U('Cart/cart_show');?>">购物车</a></strong>
			<!-- <div class="cartBox">
